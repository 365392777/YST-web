<template>
    <div class="page-container">
        ...
        >
            <el-breadcrumb-item class="bold">医生销售报表</el-breadcrumb-item>
        </el-breadcrumb>
        <el-form
            :inline="true"
            :model="listQuery"
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <router-link :to="'/statement/doctor-sales/detail/' + scope.row.docid ">
                        <el-button type="text">销售详情</el-button>
                    </router-link>
                </template>
            </el-table-column>
        </el-table>
...
<script>
import { getSalesDoctorList } from '@/api/statement'
...
export default {
    ...
    methods: {
        getList() {
            ...
            getSalesDoctorList(this.listQuery).then(res => {
