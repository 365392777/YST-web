<template>
    <div class="drafts-container">
        ...
        >
            ...
            <div class="fr">
                <el-form-item>
                    <router-link to="/popular-science/article/add">
                        <el-button
                            type="primary"
                        >新增</el-button>
                    </router-link>
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <router-link :to="'/popular-science/article/edit/' + scope.row.id">
                        <el-button
                            type="text"
                        >编辑</el-button>
                    </router-link>
...
export default {
    ...
    methods: {
        ...
        handleDelete(data) {
            updateArtStatus(data, 2).then(res => {
                const resData = res.data
                if (resData.code == '10001') {
        ...
        handlePublished(idList) {
            updateArtStatus(idList, 1).then(res => {
                const resData = res.data
                if (resData.code == '10001') {
