    ...
    >
      <!-- <el-form-item label="订单类型：">
		        <el-select v-model="listQuery.delivery" placeholder="全部" clearable>
		            ...
		            <el-option label="取消订单（已收货）" value="1"></el-option>
		            <el-option label="取消订单（未收货）" value="2"></el-option>
		            <el-option label="取消订单（为发货）" value="3"></el-option>
		        </el-select>
		    </el-form-item>
		    <el-option label="状态：">
        ...
        <tbody v-for="(tableData, index) in orders" :key="index">
          <tr>
            <td colspan="7" class="info">
              ...
              <span>取消订单时间：{{ dateTime(tableData.order.updateTime) }}</span>
          ...
          <tr>
              ...
              <table>
                <tbody>
                  <tr v-for="tableDetail in tableData.orderDetails" :key="tableDetail.detailId">
                    <td width="100px">
                      <img class="orderImg" :src="goodsImageUrl + tableDetail.images[0]">
                    </td>
                    <td>
            ...
            <!-- <td width="160px">{{ tableData.order.orderStaus }}</td> -->
            ...
            <td>
              ...
              <!-- <span class="line"></span>
							<el-button plain class="outline" v-show="" @click="">审核</el-button>
              <el-button plain class="outline" v-show="" @click="">商家已收货</el-button>-->
            </td>
          </tr>
        </tbody>
...
<script>
  import { getGoodsOrderList, exportCollectionOrder,getComoditySupplierList } from "@/api/mall";
